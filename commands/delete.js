...
module.exports = {
  data : new SlashCommandBuilder()
           .setName('delete')
           .setDescription(
               'Delete a channel from the list of channels that automatically delete messages')
           .addChannelOption(
               (option) =>
           ...
           if (!channel.permissionsFor(interaction.client.user)
             ...
             const embed =
                 new EmbedBuilder()
                     ...
                     .setDescription(
                         `You require MANAGE_MESSAGES permission to remove the bot from ${
                             channel}.`)
                     .setColor(0xff0000);
             // Send the embed
             ...
             const embed =
                 new EmbedBuilder()
                     .setTitle('Delete')
                     .setDescription(`Succesfully deleted ${
                         channel} from the list of channels that automatically delete messages.`)
                     .setColor(0x00ff00);
             // Send the embed
             await interaction.reply({embeds : [ embed ]});
           }
